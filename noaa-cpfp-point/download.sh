...
unzip -j -o co2_surface-flask_ccgg_text.zip co2_surface-flask_ccgg_text/*_event.txt -d co2/flask/surface
unzip -j -o ch4_surface-flask_ccgg_text.zip ch4_surface-flask_ccgg_text/*_event.txt -d ch4/flask/surface
unzip -j -o co2_surface-pfp_ccgg_text.zip co2_surface-pfp_ccgg_text/*_event.txt -d co2/pfp/surface
unzip -j -o ch4_surface-pfp_ccgg_text.zip ch4_surface-pfp_ccgg_text/*_event.txt -d ch4/pfp/surface
unzip -j -o co2_surface-insitu_ccgg_text.zip co2_surface-insitu_ccgg_text/*.txt -d co2/insitu/surface
unzip -j -o co2_tower-insitu_ccgg_text.zip co2_tower-insitu_ccgg_text/*.txt -d co2/insitu/tower
unzip -j -o ch4_surface-insitu_ccgg_text.zip ch4_surface-insitu_ccgg_text/*.txt -d ch4/insitu/surface
unzip -j -o ch4_tower-insitu_ccgg_text.zip ch4_tower-insitu_ccgg_text/*.txt -d ch4/insitu/tower
