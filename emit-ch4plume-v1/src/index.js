...
function createPlumesList(){
    ...
    MARKERS_ON_VIEWPORT.forEach(marker => {
        ...
        const endpoint = `https://earth.gov/ghgcenter/api/raster/collections/emit-ch4plume-v1/items/${itemId}/preview.png?bidx=1&assets=ch4-plume-emissions&rescale=1%2C1500&resampling=bilinear&colormap_name=plasma&width=120`;
