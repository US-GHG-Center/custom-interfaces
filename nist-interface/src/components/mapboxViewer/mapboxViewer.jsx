...
export class MapBoxViewer extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.props.stationCode !== prevProps.stationCode ||
      this.props.agency !== prevProps.agency ||
      this.props.region !== prevProps.region ||
      this.props.stations !== prevProps.stations
    ) {
      this.plotStations(
  ...
  render() {
    return (
      <Box
        component="main"
        className="map-section fullSize"
        sx={{ flexGrow: 1 }}
      ...
      >
        <Grid container className="fullSize">
          <Grid
            ...
            style={{ height: "100%" }}
          >
            {this.props.stations.length < 1 && this.state.currentViewer && (
              <LoadingSpinner />
            )}
            <div
              id="mapbox-container"
