...
export function NistInterface({ config: userConfig = {} }) {
  ...
  useEffect(() => {
    const fetchStationData = async () => {
      try {
        ...
        const stationCollections = extractStationCollections(
          collections,
          metaDataDict,
          agency,
          ghg,
        ...
        if (stationCode) {
          ...
          let collection = stationCollections.find((station) =>
            station.id.includes(stationCodeLowerCase)
          );
